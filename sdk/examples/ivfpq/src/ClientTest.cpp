...
#include "examples/ivfpq/src/ClientTest.h"
...
ClientTest::SearchEntities() {
    ...
    std::cout<<"dsl  :  "<<dsl_json.dump()<<std::endl;
    std::cout<<"vector_param_json  :  "<<vector_param_json.dump()<<std::endl;
    std::cout<<"json_params  :   "<<json_params.dump()<<std::endl;
